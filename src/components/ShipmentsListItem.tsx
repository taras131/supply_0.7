...
import { fetchUpdateShipmentReceiving } from "features/shipments/model/shipments";
...
import { selectInvoicesByIds } from "store/reducers/invoices";
...
const ShipmentsListItem: FC<IProps> = ({ shipment, handleChange, expanded }) => {
  ...
  const invoices = useAppSelector(selectInvoicesByIds(shipment.invoicesList));
