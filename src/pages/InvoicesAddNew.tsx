...
const InvoicesAddNew: FC = () => {
    ...
    return (
        <PageLayout maxWidth={1000}>
            ...
            <InvoicesAddNewInputFields inputValue={inputValue} setInputValue={setInputValue} fileName={fileName}
            selectedSupplierId={selectedSupplierId} setIsWithVAT={setIsWithVAT} isWithVAT={isWithVAT}
            setSelectedSupplierId={setSelectedSupplierId} handleChangeInputFile={handleChangeInputFile}
